...
function Saegus() {
  return (
    <Container id="trigger">
      <Title title="Saegus, c'est aussi" number="01" />
      {components.map((e, i) => (
        <SaegusComponent
          className="element"
          key={i}
