  ...
  return (
    <Container>
      <div className="element" ref={toZoom}>
        <h1>Saegus</h1>
        <p>
          Saegus est une consulTech qui réinvente le conseil aux entreprises.
          Elle s'est donné comme mission de faire découvrir, essayer et adopter
          le meilleur des usages du digital, sans slide. Pour de vrai.
        </p>
      </div>
    </Container>
  );
